<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ABMCampaniaExterna.aspx.cs" Inherits="ABMCampaniaExterna" %>
        ...
        <div>
            <div style="text-align: center">
                <span style="font-family: Lucida Sans Unicode"><span><span
                    style="color: #000099; font-size: 24pt;"><strong>CAMPAÑA EXTERNA</strong></span></span></span><br />
                <br />
                <table style="width: 715px; height: 265px">
                    <tr>
                        <td style="width: 281px; text-align: center">
                            <strong><span style="font-size: 14pt">ID (0 para Agregar): </span></strong>
                        </td>
                    ...
                    <tr>
                        <td style="width: 281px">
                            <strong><span style="font-size: 14pt">Nombre:</span></strong></td>
                        <td style="font-size: 12pt; text-align: left">
                            <asp:TextBox ID="TxtNombre" runat="server"></asp:TextBox></td>
                    </tr>
                    <tr style="font-size: 12pt">
                        <td style="width: 281px">
                            <span style="font-size: 14pt"><strong>Anunciante:</strong></span></td>
                        <td style="text-align: left">
                            <asp:DropDownList ID="DDLAnunciante" runat="server" Width="198px">
                            </asp:DropDownList>&nbsp;</td>
                    </tr>
                    <tr>
                        <td style="width: 281px">
                            <span style="font-size: 14pt"><strong>Fecha Inicial:</strong></span></td>
                        <td style="text-align: left">
                    ...
                    <tr>
                        <td style="width: 281px">
                            <span style="font-size: 14pt"><strong>Fecha Final:</strong></span></td>
                        <td style="text-align: left">
                    ...
                    <tr>
                        <td style="width: 281px; height: 26px;">
                            <span style="font-size: 14pt"><strong>Menciones: </strong></span>
                        </td>
                    ...
                    <tr>
                        <td style="width: 281px">
                            <strong><span style="font-size: 14pt">Productora: </span></strong>
                        </td>
                        <td style="text-align: left">
                            <asp:TextBox ID="TxtProductora" runat="server"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td style="width: 281px; height: 26px">
                            <span style="font-size: 14pt"><strong>Duracion del spot en segundos:</strong></span></td>
